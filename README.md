...
- `pages/api/*` - [API routes](https://nextjs.org/docs/api-routes/introduction) powering article reactions, article views, [`/stats`](https://manojkk.com/stats), newsletter subscription, and to generate a sitemap.
- `pages/blog/*` - Static pre-rendered blog pages that fetch information from the Notion API.
- `pages/stats` - [Site statistics](https://manojkk.com/stats) about my website.
...
```bash
$ git clone https://github.com/braydoncoyer/manojkk.com.git
$ cd manojkk.com
$ npm install
$ npm run dev
```
