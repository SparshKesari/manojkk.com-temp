        ...
        <div>
          <div className="grid items-center grid-cols-1 mt-12 text-center md:mt-24 md:text-left md:grid-cols-6">
            <h1 className="order-2 col-span-5 text-4xl leading-tight md:leading-normal md:order-1 sm:text-5xl">
              I'm{' '}
              <span className="text-teal-500 dark:text-teal-400">Manoj</span>.
              I'm a developer, open source enthusiast and DevRel at <a href="https://www.lambdatest.com/" className="underline decoration-none"><span className="text-teal-500 dark:text-teal-400">LambdaTest</span></a>.
            </h1>
